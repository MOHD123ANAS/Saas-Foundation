...
class Subscription(models.Model):
    ...
    order = models.IntegerField(default=1, help_text="Featured on Django pricing page")
    ...
    def save(self,*args, **kwargs):
        if not self.stripe_id:
            ...
            stripe_id = helper.billing.create_product(name=self.name,
        metadata={
...
class UserSubscription(models.Model):
    ...
    def billing_cycle_anchor(self):
        # optional delay to start new subscription in stripe checkout https://docs.stripe.com/payments/checkout/billing-cycle
